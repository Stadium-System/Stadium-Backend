...
<div class="bash-example">
    ...
    --form "name=John Doe"\
    --form "phone=218912345678"\
    --form "type=user"\
    --form "password=securepassword"\
    --form "first_name=John"\
    --form "last_name=Doe"\
    --form "phone_number=218912345678"\
    --form "avatar=@C:\Users\Gaafar\AppData\Local\Temp\php22EA.tmp" \
    --form "cover=@C:\Users\Gaafar\AppData\Local\Temp\php22FB.tmp" </code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's phone number. Must start with 2189 and be exactly 12 digits. Must match the regex /^2189\d{8}$/. Example: <code>218912345678</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's account type. Example: <code>user</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>admin</code></li> <li><code>user</code></li> <li><code>owner</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\Gaafar\AppData\Local\Temp\php22EA.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="file" style="display: none"
                              name="cover"                data-endpoint="POSTapi-register"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\Gaafar\AppData\Local\Temp\php22FB.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
